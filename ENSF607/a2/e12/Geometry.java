...
public class Geometry{
	...
	public void calculator(Shape s) {
		...
		System.out.print("The area, perimeter, and volume of " + s.getName() + " are: ");
		System.out.println(String.format("%.2f",s.area()) +", " + String.format("%.2f",s.perimeter()) + ", " + String.format("%.2f",s.volume()));
